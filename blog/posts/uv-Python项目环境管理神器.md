...
author: "土豆"
tags: ["uv", "Python"]
summary: "介绍 uv 这个 Rust 编写的 Python 项目管理工具，集成 pip/venv/pipx/pyenv 功能，解决环境配置难题。"
---
...
后来在试用 uv 一个下午之后，我默默地把电脑里的裸 Python 和 Miniconda 都卸了。
...
装好之后，首先解决 Python 版本的问题。uv 可以像 pyenv 一样管理多版本：
...
>
> 以及，你也可以自定义虚拟环境的名字，比如给它起名为 myenv：`uv venv myenv [--python 3.11.13]`
...
`uv pip install` 与 pip 效果完全一致——正常存入venv中使用，但是不会写入 `pyproject.toml`：
...
我们来做一个极简的问候小脚本——输入名字，输出带彩色边框的问候语，用到 rich 库。
